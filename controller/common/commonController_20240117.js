                                                                        ...
                                                                        if (vehicleInfoExist) {
                                                                            vehicleInfosDB.deleteMany({
                                                                                ...
                                                                                if (err) {
                                                                                    ...
                                                                                    console.log("deletedDocFound", deletedDocFound);
                                                                                    if (deletedDocFound) {
                                                                                        var driver_license;
                                                                                ...
                                                                                vehicleInfosDB.deleteMany({
                                                                                    ...
                                                                                    if (err) {
                                                                                        ...
                                                                                        if (deletedDocFound) {
                                                                                            ...
                                                                                            if (req.files.upload_vehicle_registration) {
                                                                                                upload_vehicle_registration = req.files.upload_vehicle_registration[0].destination + req.files.upload_vehicle_registration[0].filename;
                                                                                            } else {
                                                                                                upload_vehicle_registration = ''
                                                                                            }

                                                                                            if (req.files.upload_inssurance_card) {
                                                                                                upload_inssurance_card = req.files.upload_inssurance_card[0].destination + req.files.upload_inssurance_card[0].filename;
                                                                                            } else {
                                                                                                upload_inssurance_card = ''
                                                                                            }
                                                                                            let vehicleInfo = new vehicleInfosDB();
                                                                                            ...
                                                                                            vehicleInfo.driver_id = profile_id,
                                                                                                ...
                                                                                                vehicleInfo.vehicle_color = vehicle_color,
                                                                                                vehicleInfo.vehicle_plate_number = vehicle_plate_number,
                                                                                                vehicleInfo.upload_vehicle_registration = upload_vehicle_registration,
                                                                                                vehicleInfo.upload_inssurance_card = upload_inssurance_card,
                                                                                                vehicleInfo.upload_driver_licence = driver_license,
                                                                                                vehicleInfo.status = 1,
                                                                                                vehicleInfo.created_date = Date.now()
                                                                                ...
                                                                                vehicleInfosDB.deleteMany({
                                                                                    ...
                                                                                    if (err) {
                                                                                        ...
                                                                                        if (deletedDocFound) {
                                                                                            var driver_license;
                                                                                            if (req.files.upload_driver_licence) {
                                                                                                console.log("req.files.upload_driver_licence", req.files.upload_driver_licence);
                                                                                                driver_license = req.files.upload_driver_licence[0].destination + req.files.upload_driver_licence[0].filename;
                                                                                            } else {
                                                                                                driver_license = ''
                                                                                            }
                                                                                            if (req.files.upload_vehicle_registration) {
                                                                                                console.log("req.files.upload_vehicle_registration", req.files.upload_vehicle_registration);
                                                                                                upload_vehicle_registration = req.files.upload_vehicle_registration[0].destination + req.files.upload_vehicle_registration[0].filename || '';
                                                                                            } else {
                                                                                                upload_vehicle_registration = ''
                                                                                            }
                                                                                            ...
                                                                                            if (req.files.upload_inssurance_card) {
                                                                                                console.log("req.files.upload_inssurance_card", req.files.upload_inssurance_card);
                                                                                                upload_inssurance_card = req.files.upload_inssurance_card[0].destination + req.files.upload_inssurance_card[0].filename || '';
                                                                                            } else {
                                                                                                upload_inssurance_card = ''
                                                                                            }
